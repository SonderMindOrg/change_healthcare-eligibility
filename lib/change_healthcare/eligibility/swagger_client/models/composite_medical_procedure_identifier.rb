...
module SwaggerClient
  class CompositeMedicalProcedureIdentifier
    ...
    attr_accessor :product_or_service_id

    attr_accessor :product_or_service_id_qualifier

    attr_accessor :product_or_service_id_qualifier_code
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'productOrServiceID')
        self.product_or_service_id = attributes[:'productOrServiceID']
      end
      ...
      if attributes.has_key?(:'productOrServiceIdQualifierCode')
        self.product_or_service_id_qualifier_code = attributes[:'productOrServiceIdQualifierCode']
      end
    end
