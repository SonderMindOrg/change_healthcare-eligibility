...
module SwaggerClient
  class Loop2100ASegmentsNM1AndPERNotesInformationSourceName
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'centersForMedicareAndMedicaidPlanId')
      ...
      if attributes.has_key?(:'etin')
        self.etin = attributes[:'etin']
      end
      ...
      if attributes.has_key?(:'naic')
        self.naic = attributes[:'naic']
      end
