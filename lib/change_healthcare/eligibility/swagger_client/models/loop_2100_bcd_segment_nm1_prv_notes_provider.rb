...
module SwaggerClient
  class Loop2100BCDSegmentNM1PRVNotesProvider
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'employersId')
        self.employers_id = attributes[:'employersId']
      end
      ...
      if attributes.has_key?(:'federalTaxpayersIdNumber')
        self.federal_taxpayers_id_number = attributes[:'federalTaxpayersIdNumber']
      end
      ...
      if attributes.has_key?(:'payorIdentification')
        self.payor_identification = attributes[:'payorIdentification']
      end

      if attributes.has_key?(:'pharmacyProcessorNumber')
        self.pharmacy_processor_number = attributes[:'pharmacyProcessorNumber']
      end
      ...
      if attributes.has_key?(:'providerFirstName')
        self.provider_first_name = attributes[:'providerFirstName']
      end
      ...
      if attributes.has_key?(:'providerOrgName')
        self.provider_org_name = attributes[:'providerOrgName']
      end

      if attributes.has_key?(:'referenceIdentification')
        self.reference_identification = attributes[:'referenceIdentification']
      end

      if attributes.has_key?(:'serviceProviderNumber')
        self.service_provider_number = attributes[:'serviceProviderNumber']
      end

      if attributes.has_key?(:'servicesPlanID')
        self.services_plan_id = attributes[:'servicesPlanID']
      end
