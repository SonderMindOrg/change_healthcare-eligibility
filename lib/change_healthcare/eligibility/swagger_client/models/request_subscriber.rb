...
module SwaggerClient
  ...
  class RequestSubscriber
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'medicaidRecipientIdentificationNumber')
      ...
      if attributes.has_key?(:'spendDownAmount')
        self.spend_down_amount = attributes[:'spendDownAmount']
      end

      if attributes.has_key?(:'spendDownTotalBilledAmount')
        self.spend_down_total_billed_amount = attributes[:'spendDownTotalBilledAmount']
      end
