...
module SwaggerClient
  ...
  class Provider
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'payorId')
        self.payor_id = attributes[:'payorId']
      end
    ...
    def valid?
      provider_code_validator = EnumAttributeValidator.new('String', ['AD', 'AT', 'BI', 'CO', 'CV', 'H', 'HH', 'LA', 'OT', 'P1', 'P2', 'PC', 'PE', 'R', 'RF', 'SB', 'SK', 'SU'])
    ...
    def provider_code=(provider_code)
      validator = EnumAttributeValidator.new('String', ['AD', 'AT', 'BI', 'CO', 'CV', 'H', 'HH', 'LA', 'OT', 'P1', 'P2', 'PC', 'PE', 'R', 'RF', 'SB', 'SK', 'SU'])
