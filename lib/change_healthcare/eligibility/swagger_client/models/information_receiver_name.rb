...
module SwaggerClient
  ...
  class InformationReceiverName
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'contactNumber')
        self.contact_number = attributes[:'contactNumber']
      end

      if attributes.has_key?(:'devicePinNumber')
        self.device_pin_number = attributes[:'devicePinNumber']
      end
      ...
      if attributes.has_key?(:'facilityNetworkIdNumber')
        self.facility_network_id_number = attributes[:'facilityNetworkIdNumber']
      end

      if attributes.has_key?(:'federalTaxpayerIdentificationNumber')
        self.federal_taxpayer_identification_number = attributes[:'federalTaxpayerIdentificationNumber']
      end

      if attributes.has_key?(:'informationReceiverAdditionalIdentifierState')
      ...
      if attributes.has_key?(:'nationalProviderIdentifier')
        self.national_provider_identifier = attributes[:'nationalProviderIdentifier']
      end

      if attributes.has_key?(:'priorIdentifierNumber')
        self.prior_identifier_number = attributes[:'priorIdentifierNumber']
      end

      if attributes.has_key?(:'providerPlanNetworkIdNumber')
        self.provider_plan_network_id_number = attributes[:'providerPlanNetworkIdNumber']
      end
      ...
      if attributes.has_key?(:'stateLicenceNumber')
        self.state_licence_number = attributes[:'stateLicenceNumber']
      end

      if attributes.has_key?(:'submitterIdNumber')
        self.submitter_id_number = attributes[:'submitterIdNumber']
      end
    end
