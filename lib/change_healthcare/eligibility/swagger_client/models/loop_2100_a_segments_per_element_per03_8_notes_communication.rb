...
module SwaggerClient
  class Loop2100ASegmentsPERElementPER038NotesCommunication
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'communicationMode')
        self.communication_mode = attributes[:'communicationMode']
      end

      if attributes.has_key?(:'communicationNumber')
        self.communication_number = attributes[:'communicationNumber']
      end
    end
