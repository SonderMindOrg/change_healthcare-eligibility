...
module SwaggerClient
  class BenefitsServiceDelivery
    attr_accessor :delivery_or_calendar_pattern_code

    attr_accessor :delivery_pattern_time_code
    ...
    attr_accessor :sample_selection_modulus

    attr_accessor :time_period_qualifier

    attr_accessor :unit_for_measurement_code
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'deliveryOrCalendarPatternCode')
        self.delivery_or_calendar_pattern_code = attributes[:'deliveryOrCalendarPatternCode']
      end

      if attributes.has_key?(:'deliveryPatternTimeCode')
        self.delivery_pattern_time_code = attributes[:'deliveryPatternTimeCode']
      end

      if attributes.has_key?(:'numOfPeriods')
        self.num_of_periods = attributes[:'numOfPeriods']
      end
      ...
      if attributes.has_key?(:'sampleSelectionModulus')
        self.sample_selection_modulus = attributes[:'sampleSelectionModulus']
      end

      if attributes.has_key?(:'timePeriodQualifier')
        self.time_period_qualifier = attributes[:'timePeriodQualifier']
      end

      if attributes.has_key?(:'unitForMeasurementCode')
        self.unit_for_measurement_code = attributes[:'unitForMeasurementCode']
      end
    end
