...
module SwaggerClient
  class HealthCareInformation
    # Loop: 2100[C|D], Segment: HI, Element: HI01-2 , Notes: Diagnosis Code
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'diagnosisCode')
        self.diagnosis_code = attributes[:'diagnosisCode']
      end

      if attributes.has_key?(:'diagnosisTypeCode')
        self.diagnosis_type_code = attributes[:'diagnosisTypeCode']
      end
    end
    ...
    def valid?
      diagnosis_type_code_validator = EnumAttributeValidator.new('String', ['BK', 'ABK', 'BF', 'ABF'])
    ...
    def diagnosis_type_code=(diagnosis_type_code)
      validator = EnumAttributeValidator.new('String', ['BK', 'ABK', 'BF', 'ABF'])
      unless validator.valid?(diagnosis_type_code)
        fail ArgumentError, 'invalid value for "diagnosis_type_code", must be one of #{validator.allowable_values}.'
      end
