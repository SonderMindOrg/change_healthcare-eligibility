...
module SwaggerClient
  class Loop2100CDSegmentTRNNotesSubscriberTraceNumbers
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'originatingCompanyIdentifier')
        self.originating_company_identifier = attributes[:'originatingCompanyIdentifier']
      end
      ...
      if attributes.has_key?(:'secondaryReferenceIdentification')
        self.secondary_reference_identification = attributes[:'secondaryReferenceIdentification']
      end

      if attributes.has_key?(:'traceType')
        self.trace_type = attributes[:'traceType']
      end

      if attributes.has_key?(:'traceTypeCode')
        self.trace_type_code = attributes[:'traceTypeCode']
      end
    end
